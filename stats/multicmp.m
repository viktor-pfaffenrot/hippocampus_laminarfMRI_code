...
%  reports multiplicity adjusted p-values [1]. Other method options
...
%             procedure is implemented [3,4]. This procedure is less
...
%             implemented at a tolerance level set to alpha [5].
...
%             for the Holm-Bonferroni [6] and the false discovery rate
%             procedures [7]. For the latter, adjusted confidence intervals
%             can only be made for tests that were significant after
%             controlling the FDR.
%
%
% The algorithms for adjusting p-values are summarised in reference [8]
%
%  [1]  Wright (1992) Adjusted P-Values for Simultaneous Inference.
%        Biometrics. 48,1000-1013.
%  [2]  Holm (1979) A simple sequentially rejective multiple test
%        procedure. Scandanavian Journal of Statistics, 6:65-70
%  [3]  Holland and Copenhaver (1987) An improved sequentially
%        rejective Bonferroni test procedure. Biometrics. 43: 417-423
%  [4]  Hochberg (1988) A sharper Bonferroni procedure for multiple
%        tests of significance. Biometrika. 75: 800-802
%  [5]  Benjamini and Hochberg (1995) Controlling the False Discovery
%        Rate: A Practical and Powerful Approach to Multiple Testing.
%        Journal of the Royal Statistical Society. Series B. 57:289-300
%  [6]  Serlin, R. (1993). Confidence intervals and the scientific method:
%        A case for Holm on the range. Journal of Experimental Education.
%        61(4), 350–360.
%  [7]  Benjamini and Yekutieli (1995) False Discovery Rate–Adjusted Multiple
%        Confidence Intervals for Selected Parameters. JASA 100(469):71-81
%  [8]  Westfall (1997) Multiple Testing of General Contrasts Using
%        Logical Constraints and Correlations. JASA 92(437):299-306
%
%  multicmp v1.1.0.3 (last updated: 07/09/2022)
